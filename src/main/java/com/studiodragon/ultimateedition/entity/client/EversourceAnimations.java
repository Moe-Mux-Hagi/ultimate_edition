...
public class EversourceAnimations {
    //Import animations as text from Blockbench exported animation .JAVA file

    public static final AnimationDefinition EVERSOURCE_IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()

            .build();

    public static final AnimationDefinition EVERSOURCE_WALK = AnimationDefinition.Builder.withLength(0.5F).looping()
